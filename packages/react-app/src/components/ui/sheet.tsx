// shadcn/ui Sheet (side drawer) — wraps @radix-ui/react-dialog.
// A right-side drawer, consistent with the existing dialog.tsx primitive (v1.17, ADR-028).
